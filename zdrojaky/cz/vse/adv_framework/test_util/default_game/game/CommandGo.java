...
//== OTHER NON-PRIVATE INSTANCE METHODS ========================================
     ...
     *
     * @param parametry Room, kam se hráč chce přesunout
    ...
    public String execute(String... parametry)
    {
        ...
        Room aktuální = Room.getAktuálníMístnost();
        Collection<? extends IPlace> sousedé = aktuální.getNeighbors();
        Room cil = Room.getMístnost(parametry[0]);
        if ((cil == null)  ||  (! sousedé.contains(cil))){
            return NELZE;           //==========>
        }
        Room.setAktuálníMístnost(cil);
        return PRESUN + cil;        //==========>
    }
