...
//== HODNOTY VÝČTOVÉHO TYPU ====================================================
     ...
     *  <ul>
     *  <li>minimálníé počet kroků scénáře,</li>
     ...
     *  Scénář musí obsahovt všechny druhy kroků, které jsou ve výčtovém typu
     ...
     *  na chybně zadané píkazy hráče, také příkaz žádající nápovědu
