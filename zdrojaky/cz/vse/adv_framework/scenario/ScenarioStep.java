...
//== CONSTUCTORS AND FACTORY METHODS ===========================================
    ...
    {
        this(++lastIndex, command, message,
    ...
    {
        this(++lastIndex,
             command, message, place, neighbors, objects, bag, typeOfStep);
    }
                       ...
                       TypeOfStep typeOfStep)
    {
            ...
            invalidText(neighbors, objects, bag))
        {
            String error =
                  ...
                  "\nZadáno:";
            String notification = podpis(index, error, command, message, space,
                                         neighbors, objects, bag, typeOfStep);
...
//            TypeOfStep.tsDEMO.equals(typeOfStep)  ?  ""  :
                podpis(
                index, "Očekávaný stav po provedení akce:",
                command, message, place, neighbors, objects, bag, typeOfStep)
           ) +
            "\n";
        return ret;
...
//== PRIVATE AND AUXILIARY CLASS METHODS =======================================
     ...
     */
    private static String podpis(int      index,    String   prologue,
...
//== SOUKROMÉ A POMOCNÉ METODY INSTANCI ========================================
    ...
    /***************************************************************************
     * Zjistí, zda zadný parametr je neprázdný řetězec.
     *
     * @param text Testovaný řetězce
     * @return Je-li parametrem prázdný odkaz {@code null}, prázdný řetězec nebo
     *         obsahuje-li pouze bílé znaky, vrátí {@code true},
    ...
    /***************************************************************************
     * Zjistí, zda jsou všechny parametry neprázdné řetězce obsahující alespoň
     * jeden nebílý znak.
     *
