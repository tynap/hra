...
//== PRIVATE AND AUXILIARY INSTANCE METHODS ====================================
    ...
    private void initialize()
    {
        ...
        for (String objectName : objectNames) {
            //V této verzi rozhoduje o podobě objeku žadatel = místnost
            //Pokud název začíná znakem #, jedná se o nepřenostilený předmět
            //Přiřadí mu proto velkou váhu a odebere znak # z názvu
            objects.add((objectName.charAt(0) == '#')
                            ? new Thing(objectName.substring(1), 999)
                            : new Thing(objectName, 1)
                       );
        }
    }
