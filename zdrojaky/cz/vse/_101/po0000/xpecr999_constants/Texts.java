...
//== CONSTANT CLASS ATTRIBUTES =================================================
    ...
    public static final String
            PŘEDSÍŇ = "Předsíň",    //Room.Předsíň .name(),
            LOŽNICE = "Ložnice",    //Room.Ložnice .name(),
            OBÝVÁK  = "Obývák",     //Room.Obývák  .name(),
            KOUPELNA= "Koupelna",   //Room.Koupelna.name(),
            KUCHYŇ  = "Kuchyň" ,    //Room.Kuchyň  .name(),
            LEDNIČKA= "Lednička";   //Room.Lednička.name();
